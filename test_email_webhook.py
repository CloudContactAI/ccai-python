...
def test_email_functionality():
    ...
    ccai = CCAI(
        client_id=os.getenv('CCAI_CLIENT_ID', '2682'),
        api_key=os.getenv('CCAI_API_KEY', 'eyJhbGciOiJSUzI1NiJ9..PKVjXYHdjBMum9cTgLzFeY2KIb9b2tjawJ0WXalsb8Bckw1RuxeiYKS1bw5Cc36_Rfmivze0T7r-Zy0PVj2omDLq65io0zkBzIEJRNGDn3gx_AqmBrJ3yGnz9s0WTMr2-F1TFPUByzbj1eSOASIKeI7DGufTA5LDrRclVkz32Oo')
    )
